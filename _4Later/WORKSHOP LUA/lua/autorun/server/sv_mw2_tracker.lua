-- lua/autorun/server/sv_mw2_tracker.lua
util.AddNetworkString("MW2_Damage_Update")

util.AddNetworkString("MW2_Hitmarker")

-- We use PostEntityTakeDamage to ensure we only track real, confirmed damage
hook.Add("PostEntityTakeDamage", "MW2_Server_Track_Attacker", function(target, dmginfo, took)
